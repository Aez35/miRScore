...
miRNA secondary structure plays a big role in determining many of the miRNA criteria. If the hairpin structure forms secondary stem loops, large bulges, or if the miRNA does not index to the stem loop, the miRNA duplex can be impossible to determine. Without this duplex, it's not possible to score a miRNA locus. In this instance, miRScore will report only the user-provided information and report 'NA's.
